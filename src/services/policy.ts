...
export const GROUP_PERMISSIONS: Record<string, string[]> = {
	...
	'wp-veritas-editor_AppGrpU': [PERMISSIONS.SITE.READ, PERMISSIONS.TAGS.ASSOCIATE, PERMISSIONS.TAGS.DISSOCIATE, PERMISSIONS.TAGS.CREATE, PERMISSIONS.TAGS.CREATE, PERMISSIONS.TAGS.DELETE, PERMISSIONS.TAGS.UPDATE],
