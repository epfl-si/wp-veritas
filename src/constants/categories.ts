				...
				wp_options: [
					...
					{ name: "polylang_wpml_strings", value: [] },
					{
						...
						value: {
							...
							default_lang: site.languages.some((l) => l.split("_")[0] === "en") ? "en" : site.languages.length > 0 ? site.languages[0].split("_")[0] : "en",
						},
					},
				],
				polylang: {
