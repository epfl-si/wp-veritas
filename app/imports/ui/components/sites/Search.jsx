...
function SearchResults (props) {
  ...
  if (error == "SITE_NOT_FOUND") {
    return <div>
             <h5>Résultat</h5>
             <div className="py-1">
               Désolé, l'URL <a href={ url }>{ url }</a> n'est pas un site de l'infrastructure WordPress géré par la DSI.
             </div>
           </div>;
  } else if (error) {
  ...
  return <div>
           <h5>Résultats</h5>
           <div className="py-1">
             L'URL <a target="_blank" href={ url }>{ url }</a> a pour :
             <ul>
                <li>
                  Login (pour les ayants droit) :&nbsp;
                  <a target="_blank" href={ thisSite.url + 'wp-admin/' }>{thisSite.url + 'wp-admin/'}</a>
                </li>
               { thisUnit ?
                <li>
                ...
                </li> : <li>Unité de rattachement :&nbsp; inconnue &nbsp;({thisSite.unitId})&nbsp;</li>
               }
                <li>
