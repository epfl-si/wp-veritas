...
export class DefaultCategory extends WPVeritasCategory {
  getPlugins (site) {
    return {
      ...
      redirection: {
        // TODO: some DB operations are needed for the redirection plugin
        wp_options: [
          {
      ...
      "wp-media-folder": {
        wp_options: [
          ...
          },
          {
            ...
            value:
              '[["0-61440","kB"],["61440-122880","kB"],["122880-184320","kB"],["184320-245760","kB"],["245760-307200","kB"]]',
          },
          {
          ...
          },
          {
            ...
            value:
              '{"bgdownloadlink":"#444444","hvdownloadlink":"#888888","fontdownloadlink":"#ffffff","hoverfontcolor":"#ffffff"}',
          },
